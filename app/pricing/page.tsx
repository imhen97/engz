        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-[#F5472C]/30 bg-[#FFF5F3] p-8 shadow-lg">
              <p className="text-sm uppercase tracking-[0.25em] text-[#F5472C]">Most Popular</p>
              <h2 className="mt-4 text-2xl font-bold text-gray-900">Monthly Plan</h2>
              <p className="mt-2 text-sm text-gray-500">Join 1,200+ learners improving with ENGZ AI.</p>
              <p className="mt-6 text-3xl font-bold text-[#F5472C]">₩49,000<span className="text-base font-medium text-gray-500"> / month</span></p>
              ...
              <p className="mt-2 text-xs text-gray-400">체험은 7일 동안 무료이며 종료 전 언제든 해지 가능합니다.</p>
            </div>
            ...
            <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-lg">
              ...
              <p className="mt-2 text-sm text-gray-500">Pay yearly and save 2 months compared to monthly billing.</p>
              <p className="mt-6 text-3xl font-bold text-[#F5472C]">₩490,000<span className="text-base font-medium text-gray-500"> / year</span></p>
              <ul className="mt-6 space-y-3 text-sm text-gray-600">
              ...
              <p className="mt-2 text-xs text-gray-400">7일 무료 체험 후 청구가 시작되며 언제든 취소할 수 있습니다.</p>
            </div>
          </div>
          ...
          <div className="mt-16 rounded-3xl border border-gray-100 bg-white p-8 text-center shadow">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 text-xs text-gray-400 sm:flex-row">
              ...
              <span>• 지원이 필요하면 <Link href="/level-test" className="text-[#F5472C]">ENGZ 팀에 문의</Link></span>
            </div>
          </div>
        </div>
      </motion.section>
